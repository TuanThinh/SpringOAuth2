 ...
 * @since 1.0.0
 */
public class MongoTokenStoreDraft implements TokenStore, InitializingBean {
    private static final Marker TOKEN = MarkerFactory.getDetachedMarker("token");
    private static final Logger LOG = LoggerFactory.getLogger(MongoTokenStoreDraft.class);
    ...
    public MongoTokenStoreDraft(Mongo mongo, String databaseName) {
        this(mongo.getDB(databaseName));
    }

    public MongoTokenStoreDraft(DB db) {
